  ...
  isEmpty(currentEvent) === true
    ? (html += /*html*/ `
      ...
      <div style="display: flex; flex-direction: row; align-content: bottom; ">
        ...
        <button class="btn filled" onclick="model.inputs.history.showAll = !model.inputs.history.showAll; historyView()">vis ${
          model.inputs.history.showAll === false ? " fler" : " færre"
        }</button>
