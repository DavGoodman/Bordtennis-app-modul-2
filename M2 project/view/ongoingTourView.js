...
function ongoingTournamentView() {
  ...
  if (round == 1 && !model.inputs.ongoingTournament.score[0]) {
  ...
  <div class="logo-container" style="padding-bottom: 1.5rem;">
    ...
    for (let j = 0; j < roundArray[i].length; j++) {
      ...
      <div class="match-player">
        ...
        <div>
          ...
          <button onclick="tMinusOne(${i}, ${j}); ongoingTournamentView()" class="match-btn">&minus;</button>
          ...
          >
          <button onclick="tPlusOne(${i}, ${j}); ongoingTournamentView()" class="match-btn">&plus;</button>
